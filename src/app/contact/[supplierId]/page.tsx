...
export default function ContactSupplierPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('Contact Form Submitted:', { ...formData, supplierId: supplier?.id });
    toast({
      title: 'Message Sent',
      description: `Your message has been successfully sent to ${supplier?.name}.`,
    });
          ...
          <div className="space-y-4">
              <div>
                  ...
                  <p className="text-muted-foreground">
                      Fill out the form below to send a message to {supplier.name}. Required fields are marked with an asterisk (*).
                  </p>
              </div>
